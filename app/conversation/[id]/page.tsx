...
export default function ConversationPage() {
  ...
  // ✅ Enhanced: Find the current chat with better loading logic
  useEffect(() => {
    const findChat = async () => {
      if (conversationId) {
        // If chats are empty and not loading, refresh them
        ...
        const chat = getChatById(conversationId);
        setCurrentChat(chat || null);
        setIsInitializing(false); // ✅ Set initialization complete
      }
    };

    findChat();
  }, [conversationId, chats, getChatById, loading, refreshChats]);
  ...
  // ✅ Enhanced: Loading state - show loader while initializing or loading
  ...
  // ✅ Enhanced: Only show "Not Found" after we've actually tried to find the chat
  if (!currentChat && !loading && !isInitializing) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-white mb-4">Conversation Not Found</h2>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="relative z-10 flex h-screen">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {/* Chat Header */}
          <div className="border-b border-white/10 bg-white/5 backdrop-blur-lg p-2  flex-shrink-0">
